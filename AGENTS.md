...
| **3DBAG referansı v2025.09.03'e SABİTLENDİ** (D-027) | Kriter 1-B referansı artık `https://data.3dbag.nl/v20250903/` yayınıdır: 30 fayans, yayıncının `cj_sha256` değerleriyle doğrulandı, kapsama sınandı (0 eksik). API ile 7,376 ortak binada **0 fark** — API etiketi (`v2023.10.08`) yanlış, içeriği 2025.09.03 | `api.3dbag.nl` **referans olarak kullanılmaz** (etiketi güvenilmez, sürümü habersiz değişebilir). Aşama 1 sabitlenmiş kopyayı kullanır |
