...
| **3DBAG referansı ESKİ, girdimiz sağlam** | 3DBAG 377 bina için AHN5 yerine AHN3/AHN4 kullanmış ve AHN5 kapsamasını yetersiz bulmuş (**nedeni bilinmiyor** — "Ekim 2023 anlık görüntüsü" açıklaması sürüm etiketine dayanıyordu ve geri çekildi, D-023). **Bizim AHN5'imizde bu binaların 349'unda boşluk YOK** (medyan 25-30 p/m², ölçüldü 2026-09-21) | Kriter 1-B'de bu binalardaki fark **bizim kalitemizin değil referansın eskiliğinin** ölçüsüdür. Ayrıştırma korunur, çerçeve düzeltildi (D-021). 3DBAG'de olup güncel BAG'de olmayan **28 bina** eşleşme dışıdır, kayıp sayılmaz |
| **3DBAG sürüm kimliği BELİRSİZ** (düzeltildi 2026-09-22) | API etiketi `v2023.10.08` der; ama indirdiğimiz verinin öznitelik parmak izi **yalnızca 2025.09.03** ile tutarlı. Sürüm notlarına göre 2023.10.08'den sonra **2024.02.28, 2024.04.20, 2024.12.16 ve 2025.09.03** yayınlandı. Önceki satır "daha yeni sürüm yok" diyordu — **yanlıştı**, yalnızca API'nin beyanı okunmuştu (M-013) | Kriter 1-B'nin referans sürümü **sabitlenmeli** (P-016). Uçuş sonrası binalar için 3DBAG yine de bir yükseklik kaynağı **değildir** — ama gerekçe farklı: 2025.09.03 notu "BAG features without 3D model (typically due to a lack of elevation data) are missing from the output" der ve hiçbir sürüm AHN6 kullanmaz (D-023) |
