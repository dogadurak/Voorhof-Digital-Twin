...
| **3DBAG referansı ESKİ, girdimiz sağlam** | 3DBAG 377 bina için AHN5 yerine AHN3/AHN4 kullanmış; gerekçesi kendi AHN5 anlık görüntüsünün eksikliği. **Bizim AHN5'imizde bu binaların 349'unda boşluk YOK** (medyan 25-30 p/m², ölçüldü 2026-09-21) | Kriter 1-B'de bu binalardaki fark **bizim kalitemizin değil referansın eskiliğinin** ölçüsüdür. Ayrıştırma korunur, çerçeve düzeltildi (D-021). 3DBAG'de olup güncel BAG'de olmayan **28 bina** eşleşme dışıdır, kayıp sayılmaz |
| **3DBAG'de daha yeni sürüm yok** | API 2026-09-21'de hâlâ `v2023.10.08` döndürüyor | Uçuş sonrası binalar için 3DBAG bir yükseklik kaynağı **değildir** (P-014) |
